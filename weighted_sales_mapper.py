...
def weightedAverage(salesWeeklyDeptStoreTrainData,weekNum):
        ...
        for weekNumDiff in range(weekWindow):
            print(weekNumDiff)
            print(abs(salesWeeklyDeptStoreTrainData["WeekNum"] - weekNum))
            print(salesWeeklyDeptStoreTrainData[abs(salesWeeklyDeptStoreTrainData["WeekNum"] - weekNum) == weekNumDiff].head())
            print("\n\n")
        ...
        for weekNumDiff in range(weekWindow):
            ...
            denominator += len(histWeekDiffSales[weekNumDiff])*histWeekDiffSalesWeights[weekNumDiff]
