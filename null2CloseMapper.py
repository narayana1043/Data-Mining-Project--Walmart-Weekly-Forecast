...
Note--
The results produced have no improvement when compared to the results produced by the weighted average model,
 Hence this is not model is not given much importance.
----
"""
def null_mapper():
